...
type Summary = { attendance: { present: number; absent: number; marked: number; activeGuards: number }; payroll: { guardNet: number; companyNet: number; margin: number } };
